...
import "./JsirfIndScoreDropdown.css";
    ...
    <>
      <div className="datavaldiv">
        <Grid container style={{ marginBottom: '-10px' }}>
          <Grid item xs={2.2} >
            <Item className="custom-MuiPaper-root4">
        ...
        <Grid container>
          <Grid item xs={2.2} sx={{ marginTop: "2.5px" }}>
            <Item className="custom-MuiPaper-root5">
              <FormControl className="formControl"
                sx={{
                  width: "55%",
                  "& .MuiInputLabel-root": {
              ...
              >
                ...
                >
                  <InputLabel
                    ...
                    <Checkbox style={{ color: 'white', size: '10px' }} checked={itemsChecked} onChange={selectItem} />
                    Select All
                  </InputLabel>
                  {names.map((name) => (
        ...
        <Grid container>
          <Grid item xs={2.2} sx={{ marginTop: "2.5px" }}>
            <Item className="custom-MuiPaper-root6">
              <FormControl className="formControl"
                sx={{
                  width: "55%",
                  "& .MuiInputLabel-root": {
        ...
        {(personName1 === undefined || personName1 === null || personName2?.length === 0 || personName3?.length === 0) ?
          (
            <Button
              onClick={() => handleClickDrawData()}
              disabled
              className="Custom-Mui-disabled"
              style={{ marginLeft: "42%", marginTop: "55px", marginBottom: "30px", color: "white", fontSize: "14px", backgroundColor: "black", textTransform: "none", width: "15%", height: "50px" }}>
              Check Results
            </Button>
          ) : (
