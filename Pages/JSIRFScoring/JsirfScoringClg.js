...
const JsirfScoringClg = () => {
  ...
  return (
    <>
      <Typography className="page-heading" sx={{ fontSize: `${pageheadfont}px`, color: localStorage.getItem('theme') === 'dark' ? '#ffffff!important' : '#12442D', marginLeft: '2%' }}>Results (JSIRF Score)</Typography>
              ...
              <TableRow >
                ...
                <TableCell className="allscoretableheader"
                  sx={{
                    ...
                    fontSize: `${tableheadfont}px`,
                    color: localStorage.getItem('theme') === 'dark' && 'rgba(255, 255, 255, 1)!important'
                  }} align='center'>JSIRF Score</TableCell>
              </TableRow>
            </TableHead>
...
export default JsirfScoringClg
